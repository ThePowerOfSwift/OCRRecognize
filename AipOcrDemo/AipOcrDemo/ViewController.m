...
//    [photoBtn setFrame:CGRectMake((ODSScreenWidth-150)/2, (ODSScreenHeight-64)/2-45-10, 150, 45)];
//    [photoBtn setBackgroundColor:[UIColor colorWithRed:0.027 green:0.58 blue:0.757 alpha:0.8]];
//    [photoBtn.titleLabel setFont:[UIFont systemFontOfSize:14]];
//    [self.view addSubview:photoBtn];
//    photoBtn.tag = 5;
//    photoBtn.layer.cornerRadius = 5;
//    photoBtn.layer.masksToBounds = YES;
//    [photoBtn setTitle:@"选择图片" forState:UIControlStateNormal];
//    [photoBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
//    [photoBtn addTarget:self action:@selector(bankCardOCROnlineScan) forControlEvents:UIControlEventTouchUpInside];
//    
//    
//    UIButton * cameraBtn = [UIButton buttonWithType:UIButtonTypeCustom];
//    [cameraBtn setFrame:CGRectMake((ODSScreenWidth-150)/2, (ODSScreenHeight-64)/2+10, 150, 45)];
//    [cameraBtn setBackgroundColor:[UIColor colorWithRed:0.027 green:0.58 blue:0.757 alpha:0.8]];
//    [cameraBtn.titleLabel setFont:[UIFont systemFontOfSize:14]];
//    [self.view addSubview:cameraBtn];
//    cameraBtn.tag = 5;
//    cameraBtn.layer.cornerRadius = 5;
//    cameraBtn.layer.masksToBounds = YES;
//    [cameraBtn setTitle:@"相机拍照" forState:UIControlStateNormal];
//    [cameraBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
//    [cameraBtn addTarget:self action:@selector(bankCardOCROnlineScan) forControlEvents:UIControlEventTouchUpInside];
